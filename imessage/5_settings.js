        ...
        history.forEach(item => {
            ...
            el.innerHTML = `
                ...
                <div class="thought-edit-area" style="display: none; width: 100%;">
                    <textarea class="tall-input" style="width: 100%; height: 80px; box-sizing: border-box; background: #ffffff; padding: 12px; border-radius: 12px; border: 1px solid #007aff; resize: none; font-size: 15px; box-shadow: 0 1px 2px rgba(0,0,0,0.05);">${item.content}</textarea>
                </div>
            `;
